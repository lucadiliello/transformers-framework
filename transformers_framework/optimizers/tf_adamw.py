...
class TFAdamWOptimizer(Optimizer, TFAdamW):
    ...
    def __init__(self, hyperparameters: ExtendedNamespace, named_parameters: Generator):
        ...
        super().__init__(
            ...
            betas=hyperparameters.tfadamw_betas,
            eps=hyperparameters.tfadamw_epsilon,
            weight_decay=hyperparameters.weight_decay,
            amsgrad=hyperparameters.tfadamw_amsgrad
        )

    @classmethod
    def add_argparse_args(cls, parser: FlexibleArgumentParser):
        super().add_argparse_args(parser)
        parser.add_argument('--tfadamw_epsilon', type=float, default=1e-6)
        parser.add_argument('--tfadamw_betas', nargs=2, type=float, default=[0.9, 0.999])
        parser.add_argument('--tfadamw_amsgrad', action='store_true')
